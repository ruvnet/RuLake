...
The deep reference for ruLake. The [README](README.md) is the 60-second pitch + install; this is everything else.

For the **screen-by-screen Console walkthrough** (with all 7 screenshots), see [`docs/userguide/`](docs/userguide/) — 11 markdown files covering Stats / App Store / Connect / Backends / Bundle / Playground / Audit + Live MCP setup + Troubleshooting.

For the **plugin marketplace** (the `/plugin install rulake-stack` flow), see [ADR-009](docs/adrs/sdk/ADR-009-rulake-plugin-marketplace.md).

## Contents

- [Architecture diagram](#architecture-diagram) — the one-screen mental model
- [ruLake vs typical vector DBs](#rulake-vs-typical-vector-databases-15-differences) — collapsed
- [Full capabilities (35 features across 7 categories)](#see-full-capabilities-30-features-across-7-categories) — collapsed
- [Why ruLake exists](#why-rulake-exists)
- [Performance — what to actually expect](#performance--what-to-actually-expect)
- [Quick start (extended)](#quick-start)
- [How it works](#how-it-works)
- [Examples](#examples)
- [Status](#status)
- [Comparison with other systems](#comparison-with-other-systems)
- [RuVector ecosystem](#ruvector-ecosystem)
- [License](#license)
- [Links](#links)
