...
**Originally accepted (M1)** — core abstraction + LocalBackend +
FsBackend shipped and measured on branch
`research/rulake-datalake-analysis`. Backend adapters (Parquet,
BigQuery, Iceberg, Delta) were M2+.
